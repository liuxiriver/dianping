...
base_font = TTFont('345d4896.woff')  # 打开本地字体文件
# # 获取GlyphOrder节点的name值
...
with open('base_dict', 'r', encoding='utf-8') as f:
     base_dict = f.read()
# 减少内容，使用MD5将 字体坐标进行摘要处理
for uni1 in base_uni_list:
     # 去字体md5值
     obj1 = list(base_font['glyf'][uni1].coordinates)
     contour_md5 = md5(bytes(str(obj1), encoding='utf-8')).hexdigest()
     print(contour_md5)
     with open('base_glyf_dict', 'a', encoding='utf-8') as f:
          f.write(contour_md5)


# print(base_dict)
# new_font = TTFont('30edb6cc.woff')
